...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -2533.8195631668964; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 950.4036467312716; // x position of the perpendicular encoder (in tick units)
    }
